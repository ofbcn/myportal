            ...
            <table cellspacing="0" class="basic-table">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><div><img id="captchaImage" src="<@noerpUrl>captcha.jpg?captchaCodeId=captchaImage&amp;unique=${nowTimestamp.getTime()}</@noerpUrl>" alt="" /></div></td>
                    </tr>
                    <script type="text/javascript" language="JavaScript">
                    <!--
                        function reloadCaptcha(fieldName) {
                            var captchaUri = "<@noerpUrl>captcha.jpg?captchaCodeId=" + fieldName + "&amp;unique=_PLACEHOLDER_</@noerpUrl>";
                            var unique = Date.now();
